...
public class TestDownloadPdf extends ActionSupport implements ServletContextAware{
	...
	{	
		...
		try
		{
			...
			over.setFontAndSize(bf, 13);
			over.setTextMatrix(440, 690);
			over.showText("Sex :");
			
			
			over.setFontAndSize(bf, 12);
			over.setTextMatrix(475, 690);
