...
public class Savecc extends ActionSupport{
	 ...
	 static final long serialVersionUID = -1450168026131640345L;
	    ...
	    private String[]gennameout;
	    private String[]drugnameout;
	    private String[]drgqtyout;
	    private String[]tknqtyout;	   
	    private String[]doseout;
	    private String[]daysout;
	    private String[]takingtimeout;
	    private String[]rxstatusout;
		...
		private List<PrescriptionDTO> medicineout;
		...
		{	    	
	    	...
	    	pDao.insertValue(ccname, cctype, comments, prescriptionid, patientid,oename,oecomments,pcomments,
	    				  genname,drugname,drgqty,dose,days,takingtime,tknqty,gennameout,drugnameout,drgqtyout,doseout,daysout,takingtimeout,tknqtyout,
	    				  rxstatus,dname,dcomments,testypename,testname,tstcomm,advcomments,visitid,uprice,tstprice,tstvat,
	    				  medOutSide,testOutSide, user.getOfficalid(),weight,rxstatusout);
			...
			doctorname = user.getUserfullname();
			...
			medicineout=pDao.meddisplayout(prescriptionid);	
			...
			weight=pDao1.weight(prescriptionid);
		...
		public String show()
			...
			weight=pDao.weight(prescriptionid); 
		...
		public String[] getGennameout() {
			return gennameout;
		}

		public void setGennameout(String[] gennameout) {
			this.gennameout = gennameout;
		}

		public String[] getDrugnameout() {
			return drugnameout;
		}

		public void setDrugnameout(String[] drugnameout) {
			this.drugnameout = drugnameout;
		}

		public String[] getDrgqtyout() {
			return drgqtyout;
		}

		public void setDrgqtyout(String[] drgqtyout) {
			this.drgqtyout = drgqtyout;
		}

		public String[] getTknqtyout() {
			return tknqtyout;
		}

		public void setTknqtyout(String[] tknqtyout) {
			this.tknqtyout = tknqtyout;
		}

		public String[] getDoseout() {
			return doseout;
		}

		public void setDoseout(String[] doseout) {
		...
		public String[] getTakingtimeout() {
			return takingtimeout;
		}

		public void setTakingtimeout(String[] takingtimeout) {
			this.takingtimeout = takingtimeout;
		}
		...
		public List<PrescriptionDTO> getMedicineout() {
			return medicineout;
		}

		public void setMedicineout(List<PrescriptionDTO> medicineout) {
			this.medicineout = medicineout;
		}

		public String[] getRxstatusout() {
			return rxstatusout;
		}

		public void setRxstatusout(String[] rxstatusout) {
			this.rxstatusout = rxstatusout;
		}
