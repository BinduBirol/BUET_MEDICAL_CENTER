...
import com.mcenter.totalBill.TotalBillofMonth;
import com.opensymphony.xwork2.ActionContext;
import com.opensymphony.xwork2.ActionSupport;



public class TotalbillofMonthReport  extends HttpServlet {
   ...
   public void setFdate(String fdate) {
	...
	public String report() throws Exception{
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		TotalBillofMonth  dDAO = new TotalBillofMonth();
	    		dDAO.report(fdate,tdate);
	   ...
	   ////////////////////////////////////////////////////////////       
	        ...
	        /*   // PdfWriter.getInstance(document, baos);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            float[] colWidths = {10f,40f,25f,25f};
	            ...
	            cellnew = new PdfPCell(new Phrase(" ",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellnew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellnew.setBorder(Rectangle.NO_BORDER);
	            table1.addCell(cellnew);
	            
	            cellnew = new PdfPCell(new Phrase("Medicine/Pathology Bill from"+" "+fdate+" "+"to"+" "+tdate,new Font(Font.FontFamily.HELVETICA,9,
                        Font.BOLD)));
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            cellinfo = new PdfPCell(new Phrase("From:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            ...
	            cellinfo = new PdfPCell(new Phrase(fdate,new Font(Font.FontFamily.HELVETICA,9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("To:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(tdate,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	         ...
	         ////////////////////////////////////
	            ...
	            // create header cell
	            PdfPCell cellbar2 = new PdfPCell(new Phrase("Total Bill",font1));
	            // set Column span "1 cell = 6 cells width"
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           /* //Create Paragraph
	            ...
	            float[] columnWidths = new float[] {10f,15f, 35f, 25f, 15f,15f,15f,15f};
	            pdfTable.setWidths(columnWidths);
	            
	            document.add(pdfTable);
	            
	            
	            PdfPCell cell1 = new PdfPCell(new Phrase("No".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            ...
	            cell1 = new PdfPCell(new Phrase("Medical ID".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            pdfTable.addCell(cell1);
	            
	            cell1 = new PdfPCell(new Phrase("Name".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            pdfTable.addCell(cell1);

	            cell1 = new PdfPCell(new Phrase("Designation".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            ...
	            cell1 = new PdfPCell(new Phrase("Department".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            pdfTable.addCell(cell1);
	            
	            cell1 = new PdfPCell(new Phrase("Total Medicine Bill".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            pdfTable.addCell(cell1);
	            
	            cell1 = new PdfPCell(new Phrase("Total Test Bill".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	            ...
	            cell1 = new PdfPCell(new Phrase("Total  Bill".toUpperCase(),new Font(Font.FontFamily.HELVETICA,8,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	           ...
	           System.out.println("Size:"+dDAO.getTotalbillListreport().size()); 
	           
	          
	           TotalBillofMonth  DAO = new TotalBillofMonth();
		      
	           
           for( i=0;i<dDAO.getTotalbillListreport().size();i++)
            {
        	    DAO =dDAO.getTotalbillListreport().get(i);
	            
        	    
        	    PdfPCell cell2 = new PdfPCell(new Phrase(String.valueOf(i+1),new Font(Font.FontFamily.TIMES_ROMAN, 9,
                        Font.NORMAL)));
	            cell2.setHorizontalAlignment(Element.ALIGN_CENTER);
        	    pdfTable.addCell(cell2);
        	    
        	    
        	    PdfPCell cell3 = new PdfPCell(new Phrase(DAO.getMedicalID(),new Font(Font.FontFamily.TIMES_ROMAN, 9,
                        Font.NORMAL)));
	            cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell3 );
	            
	            PdfPCell cell4 = new PdfPCell(new Phrase(DAO.getName(),new Font(Font.FontFamily.TIMES_ROMAN, 9,
                        Font.NORMAL)));
	            cell4.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell4 );
	            
	            
	            PdfPCell cell5 = new PdfPCell(new Phrase(DAO.getDesignation(),new Font(Font.FontFamily.TIMES_ROMAN, 8,
                        Font.NORMAL)));
	            cell5.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell5);
	            
	            PdfPCell cell6 = new PdfPCell(new Phrase(DAO.getDepartment(),new Font(Font.FontFamily.TIMES_ROMAN, 8,
                        Font.NORMAL)));
	            cell6.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell6);
	            
	            PdfPCell cell7 = new PdfPCell(new Phrase(DAO.getTotalMedicinebill(),new Font(Font.FontFamily.TIMES_ROMAN,8,
                        Font.NORMAL)));
	            cell7.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell7);
	            
	            PdfPCell cell8= new PdfPCell(new Phrase(DAO.getTotalTestbill(),new Font(Font.FontFamily.TIMES_ROMAN,8,
                        Font.NORMAL)));
	            cell8.setHorizontalAlignment(Element.ALIGN_LEFT);
	            pdfTable.addCell(cell8);
	            
	            PdfPCell cell9 = new PdfPCell(new Phrase(DAO.getTotalbill(),new Font(Font.FontFamily.TIMES_ROMAN,8,
                        Font.NORMAL)));
...
//cell1.setColspan(4);
          /* cell1 = new PdfPCell(new Phrase("",new Font(Font.FontFamily.HELVETICA, 12,
           ...
           cell1 = new PdfPCell(new Phrase("Grand Total:",new Font(Font.FontFamily.HELVETICA, 9,
                   Font.BOLD)));
           cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
           cell1.setGrayFill(0.9f);
           cell1.setColspan(5);
           ...
           cell1 = new PdfPCell(new Phrase(Double.toString(dDAO.getTotalmed()),new Font(Font.FontFamily.HELVETICA, 9,
                   Font.BOLD)));
           cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
          cell1.setGrayFill(0.9f);
          pdfTable.addCell(cell1);
          
          cell1 = new PdfPCell(new Phrase(Double.toString(dDAO.getTotaltest()),new Font(Font.FontFamily.HELVETICA, 9,
                  Font.BOLD)));
          cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
         cell1.setGrayFill(0.9f);
         pdfTable.addCell(cell1);
         
         cell1 = new PdfPCell(new Phrase(Double.toString(dDAO.getTotal()),new Font(Font.FontFamily.HELVETICA, 9,
                 Font.BOLD)));
         cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
        cell1.setGrayFill(0.9f);
        pdfTable.addCell(cell1);
...
pdfTable.addCell(Double.toString(DAO.getTotal())+" "+"Taka only");*/
	          ...
	          /*  PdfPTable tableword = new PdfPTable(2);
	            ...
	            Paragraph paragraph = new Paragraph("Prepared by :",new Font(Font.FontFamily.TIMES_ROMAN, 10,
	            	      Font.BOLD));
	            paragraph.setAlignment(Element.ALIGN_LEFT);
	            //New line
	         
	           // paragraph.add(new Paragraph(" "));
	            paragraph.add(new Paragraph(user.getUserfullname(),new Font(Font.FontFamily.TIMES_ROMAN, 9,
	            	      Font.NORMAL)));
	            paragraph.setAlignment(Element.ALIGN_LEFT);
	            
	            paragraph.add(new Paragraph(user.getUserdesignation(),new Font(Font.FontFamily.TIMES_ROMAN, 9,
	            	      Font.NORMAL)));
	            paragraph.setAlignment(Element.ALIGN_LEFT);
