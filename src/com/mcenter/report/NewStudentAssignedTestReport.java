...
public class NewStudentAssignedTestReport  extends HttpServlet {
 ...
 */
	...
	public String report() throws Exception{
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		dDAO.testTABLEreport(receiptNONewstudent);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            cellnew = new PdfPCell(new Phrase("Assigned test for new admitted student",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
...
/*	            cellinfo = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
          ...
          // staticCell.setGrayFill(0.9f);
           ...
           staticCell = new PdfPCell(new Phrase("           ".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           //staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(1);
           ...
           staticCell = new PdfPCell(new Phrase("           ",new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
          // staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(1);
