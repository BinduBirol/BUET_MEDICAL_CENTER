...
public class finalTestReportAdmission  extends HttpServlet {
 ...
 */
	...
	public String report(String receiptNO,String abo,String rhd,String hbsag) throws Exception{
	        try {
	          ...
	          /*  Font font1 = new Font(Font.COURIER, 8, Font.BOLD); 
	        	...
	        	receiptNONewstudent=request.getParameter("receiptNUMBER");
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		dDAO.testTABLEreport(receiptNO);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            cellnew = new PdfPCell(new Phrase("Tests result of new admitted student",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	           ...
	           // document.add( Chunk.NEWLINE );
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getMeritPosition(),new Font(Font.FontFamily.HELVETICA, 11,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
...
/*	            cellinfo = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
	        ...
	        document.add(infotable);
	         ...
	         ////////////////////////////////////
	          document.add( Chunk.NEWLINE );
	            ...
	            // ----------------Table Header "Title"----------------
	            // font
	            Font font1 = new Font(FontFamily.TIMES_ROMAN, 14, Font.BOLD, BaseColor.WHITE);
	            // create header cell
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           /* document.add( Chunk.NEWLINE );
	            ...
	            float[] columnWidths = new float[] {10f,40f,50f};
           ...
           //  document.add(pdfTable);   this for dynamic table---->table is already done just need to be added
           
           PdfPTable staticTable = new PdfPTable(4);
           
          // set the width of the table to 100% of page
           
           staticTable.setWidthPercentage(100);
           float[] staticTableWidth = {10f,50f,20f,50f};
           staticTable.setWidths(staticTableWidth);
           
           PdfPCell staticCell = new PdfPCell(new Phrase("No".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.BOLD)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           staticCell.setGrayFill(0.9f);
           /*cell1.setPhrase(new Phrase(header.toUpperCase(),
                   new Font(Font.FontFamily.HELVETICA, 10,
                           Font.BOLD)));*/
           
           staticTable.addCell(staticCell);
           
           staticCell = new PdfPCell(new Phrase("Test Name".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.BOLD)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           staticCell.setGrayFill(0.9f);
           staticTable.addCell(staticCell);

           staticCell = new PdfPCell(new Phrase("Result".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.BOLD)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           staticCell.setGrayFill(0.9f);
           ...
           staticCell = new PdfPCell(new Phrase("01".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
          // staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(2);
           staticTable.addCell(staticCell);
           
           staticCell = new PdfPCell(new Phrase("Blood Group",new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           ...
           staticCell = new PdfPCell(new Phrase("ABO",new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setPaddingBottom(5);
           staticCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
          // staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(1);
           staticTable.addCell(staticCell);
           
           staticCell = new PdfPCell(new Phrase(abo.toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           //staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(1);
           ...
           staticCell = new PdfPCell(new Phrase("Rh(D)",new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
           staticCell.setPaddingBottom(5);
           //staticCell.setGrayFill(0.9f);
           ...
           staticCell = new PdfPCell(new Phrase(rhd,new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
          // staticCell.setGrayFill(0.9f);
           staticCell.setRowspan(1);
           ...
           staticCell = new PdfPCell(new Phrase("02".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
           ...
           staticCell = new PdfPCell(new Phrase("HBsAg(Screening)",new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_LEFT);
           staticCell.setPaddingBottom(5);
          
           staticCell.setColspan(1);
           staticTable.addCell(staticCell);
           
           staticCell = new PdfPCell(new Phrase(hbsag,new Font(Font.FontFamily.HELVETICA, 12,
                   Font.NORMAL)));
           staticCell.setHorizontalAlignment(Element.ALIGN_CENTER);
