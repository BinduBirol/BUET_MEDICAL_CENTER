...
public class PhysicalAndTestReport extends HttpServlet {
 ...
 */
	...
	private int i;
	private String receiptNOPhysicalTest;
	
	public String getReceiptNOPhysicalTest() {
		return receiptNOPhysicalTest;
	}

	public void setReceiptNOPhysicalTest(String receiptNOPhysicalTest) {
		this.receiptNOPhysicalTest = receiptNOPhysicalTest;
	}
	...
	public String report() throws Exception{
	        try {
	          ...
	          /*  Font font1 = new Font(Font.COURIER, 8, Font.BOLD); 
	        	...
	        	receiptNOPhysicalTest=request.getParameter("receiptNO");
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		Physicaltest  dDAO = new Physicaltest();
	    		dDAO.physicalexaminationANDtestREPORT(receiptNOPhysicalTest);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // document.add( Chunk.NEWLINE );
	            ...
	            cellinfo = new PdfPCell(new Phrase("Purpose:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getPurpose(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getReceiptNUMBER(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("Name:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getName(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
...
/*	            cellinfo = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            */
	            ...
	            ////////////////////////////////////
	        PdfPTable physicalinfotable = new PdfPTable(2);
	        physicalinfotable.setWidthPercentage(50);
            float[] colWidthsphysicalinfotableinfo = {50f,50f};
            ...
            document.add(physicalinfotable);
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	          ...
	          /*  cell1 = new PdfPCell(new Phrase("Rate".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
	           ...
	           Physicaltest  DAO = new Physicaltest();
