...
import com.mcenter.labtestBillManagement.TestInsiderForOutDoc;
import com.opensymphony.xwork2.ActionContext;
import com.opensymphony.xwork2.ActionSupport;



public class insiderOutDocReport  extends HttpServlet {
 ...
 */
	...
	public String report() throws Exception{
	        try {
	    		...
	    		TestInsiderForOutDoc  dDAO = new TestInsiderForOutDoc();
	           ...
	           ByteArrayOutputStream baos = new ByteArrayOutputStream();
	            ...
	            cellnew = new PdfPCell(new Phrase("Test bill of Insider patient",new Font(Font.FontFamily.HELVETICA, 13,
                        Font.BOLD)));
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getSerial(),new Font(Font.FontFamily.HELVETICA,9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           TestInsiderForOutDoc  DAO = new TestInsiderForOutDoc();
