...
import com.mcenter.pharmasistBillManagement.PathTestBill;
 ...
 */
	...
	public String report() throws Exception{
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		PathTestBill  dDAO = new PathTestBill();
	    		dDAO.testBillReport(visitID,billID);
	        ...
	        /*   // PdfWriter.getInstance(document, baos);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            cellnew = new PdfPCell(new Phrase("Test bill of regular patient",new Font(Font.FontFamily.HELVETICA, 13,
                        Font.BOLD)));
	          ...
	          //  infotable.setWidthPercentage(50);
	            ...
	            cellinfo = new PdfPCell(new Phrase("Patient Age:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getAgeStr()+" "+"years old.",new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	           ...
	           cellinfo = new PdfPCell(new Phrase(dDAO.getPatientID(),new Font(Font.FontFamily.HELVETICA, 9,
	            ...
	            cellinfo = new PdfPCell(new Phrase("Patient Sex:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("Relation with patient:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           /* //Create Paragraph
	            ...
	            float[] columnWidths = new float[] {10f,30f,25f,10f,10f,15f};
               ...
               cell1 = new PdfPCell(new Phrase("Test Type".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
	            ...
	            cell1 = new PdfPCell(new Phrase("Test".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	           ...
	           PathTestBill  DAO = new PathTestBill();
           ...
           for( i=0;i<dDAO.getPharmacyMedicineBilllist().size();i++)
            {
        	    ...
        	    pdfTable.addCell(cell2);
         	    ...
         	    PdfPCell cell3 = new PdfPCell(new Phrase(DAO.getTestTypeName(),new Font(Font.FontFamily.TIMES_ROMAN, 11,
                        Font.NORMAL)));
	            ...
	            PdfPCell cell6 = new PdfPCell(new Phrase(Double.toString(0.0),new Font(Font.FontFamily.TIMES_ROMAN, 11,
                        Font.NORMAL)));
	            cell6.setHorizontalAlignment(Element.ALIGN_CENTER);
	            pdfTable.addCell(cell6);
	            
	            
	            PdfPCell cell7 = new PdfPCell(new Phrase(Double.toString(DAO.getTotal()),new Font(Font.FontFamily.TIMES_ROMAN, 11,
                        Font.NORMAL)));
