...
public class NewstudentPhysicalAndTestReport  extends HttpServlet {
 ...
 */
	...
	private int i;
	private String receiptNONewstudent;
	
	
	

	public String getReceiptNONewstudent() {
		return receiptNONewstudent;
	}




	public void setReceiptNONewstudent(String receiptNONewstudent) {
		this.receiptNONewstudent = receiptNONewstudent;
	}
	...
	public String report() throws Exception{
	        try {
	          ...
	          /*  Font font1 = new Font(Font.COURIER, 8, Font.BOLD); 
	        	...
	        	receiptNONewstudent=request.getParameter("receiptNO");
	    	...
	    	//	PdfWriter.getInstance( document, response.getOutputStream() );
	    		...
	    		MoneyReceiptforNewstudentMedicalCheckup  dDAO = new MoneyReceiptforNewstudentMedicalCheckup();
	    		dDAO.physicalexaminationANDtestREPORT(receiptNONewstudent);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            float[] colWidths = {10f,30f,10f,50f};
	            ...
	            cellnew = new PdfPCell(new Phrase("Physical Examination And Test Result",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	           ...
	           // document.add( Chunk.NEWLINE );
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getReceiptNO(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getStudentname(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getFather(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getDob(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getAcadenicsession(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getGroup_id(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getMeritPosition(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("  ",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("  ",new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
...
/*	            cellinfo = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            cellinfo = new PdfPCell(new Phrase(dDAO.getAmount(),new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	        ...
	        document.add(infotable);
	             ...
	             PdfPTable table3 = new PdfPTable(6);
		            ...
		            // set relative columns width
	                 table3.setWidths(new float[]{0.6f, 1.4f, 0.8f,0.8f,1.8f,2.6f});
		     
		            // ----------------Table Header "Title"----------------
		            // font
		            Font font3 = new Font(FontFamily.TIMES_ROMAN, 12, Font.BOLD, BaseColor.WHITE);
		            // create header cell
		            PdfPCell cellbar3 = new PdfPCell(new Phrase("Physical Examination Result",font3));
		            // set Column span "1 cell = 6 cells width"
		            cellbar3.setHorizontalAlignment(Element.ALIGN_CENTER);
		            cellbar3.setVerticalAlignment(Element.ALIGN_MIDDLE);
		     
		            // padding
		            cellbar3.setPaddingLeft(3f);
		            cellbar3.setPaddingTop(0f);
		     
		            // background color
		            cellbar3.setBackgroundColor(BaseColor.GRAY);
		     
		            // border
		            cellbar3.setBorder(0);
		            cellbar3.setBorderWidthBottom(1);
		            cellbar3.setBorderColorBottom(BaseColor.GRAY);
		     
		            // height
		            cellbar3.setMinimumHeight(12f);
		            cellbar3.setColspan(6);
		            // set style
		           // Style.headerCellStyle(cell);
		            // add to table
		            table3.addCell(cellbar3);
		            document.add(table3);
	          
	            
	            ////////////////////////////////////
	        PdfPTable physicalinfotable = new PdfPTable(4);
	        physicalinfotable.setWidthPercentage(100);
            float[] colWidthsphysicalinfotableinfo = {50f,50f,50f,50};
            physicalinfotable.setWidths(colWidthsphysicalinfotableinfo);
            physicalinfotable.setSpacingBefore(10);
            
            
            PdfPCell physicalcellinfo = new PdfPCell();
           
            physicalcellinfo = new PdfPCell(new Phrase("Height:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            physicalinfotable.addCell(physicalcellinfo);
            
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalheight(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Weight:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalweight(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Pulse rate:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalpulserate(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Blood Pressure :",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalbloodpressureSystolic()+" "+"and"+" "+dDAO.getGlobalbloodpressureDiastolic(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Eye sight(Right):",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobaleyesightR(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            physicalinfotable.addCell(physicalcellinfo);
            physicalcellinfo = new PdfPCell(new Phrase("Eye sight(Left):",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobaleyesightL(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Colour Blindness:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalcolourblindness(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Hearing:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalhearing(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Speech:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalspeech(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Lungs:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGloballungs(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase("Heart:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalheart(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
...
/*            physicalcellinfo = new PdfPCell(new Phrase("P/A/E:",new Font(Font.FontFamily.HELVETICA, 10,
                    Font.BOLD)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            physicalcellinfo = new PdfPCell(new Phrase(dDAO.getGlobalpae(),new Font(Font.FontFamily.HELVETICA, 9,
                    Font.NORMAL)));
            physicalcellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
            physicalcellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
            physicalcellinfo.setBorder(Rectangle.NO_BORDER);
            ...
            document.add(physicalinfotable);
	         ...
	         ////////////////////////////////////
	            ...
	            // ----------------Table Header "Title"----------------
	            // font
	            Font font1 = new Font(FontFamily.TIMES_ROMAN, 12, Font.BOLD, BaseColor.WHITE);
	            // create header cell
	            PdfPCell cellbar2 = new PdfPCell(new Phrase("Assigned Test List",font1));
	            // set Column span "1 cell = 6 cells width"
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           /* document.add( Chunk.NEWLINE );
	            ...
	            cell1 = new PdfPCell(new Phrase("Test Result".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
                        Font.BOLD)));
	            cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
	            cell1.setGrayFill(0.9f);
	          ...
	          /*  cell1 = new PdfPCell(new Phrase("Rate".toUpperCase(),new Font(Font.FontFamily.HELVETICA, 12,
	           ...
	           System.out.println("Size:"+dDAO.getAssignedTestlist().size()); 
	           
	          
	           MoneyReceiptforNewstudentMedicalCheckup  DAO = new MoneyReceiptforNewstudentMedicalCheckup();
		      
	           
           for( i=0;i<dDAO.getAssignedTestlist().size();i++)
            {
        	    DAO =dDAO.getAssignedTestlist().get(i);
	            ...
	            PdfPCell cell5 = new PdfPCell(new Phrase(DAO.getTestResult(),new Font(Font.FontFamily.TIMES_ROMAN, 11,
                        Font.NORMAL)));
