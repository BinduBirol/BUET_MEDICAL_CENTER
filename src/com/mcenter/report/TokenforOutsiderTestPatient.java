...
public class TokenforOutsiderTestPatient   extends HttpServlet {
 ...
 */
	...
	public String report(String patientname,String patientID,String designation,String refDoctor,String gender,String ageStr,String serialNumber) throws Exception{
	        try {
	   ...
	   //////////////////////////////////////////////////////////// 
	          ...
	          /*  cellinfo = new PdfPCell(new Phrase("Visiting Date:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            infotable.addCell(cellinfo);*/
	           // patientname,patientID,designation,refDoctor,gender,ageStr,serialNumber
	            ...
	            cellinfo = new PdfPCell(new Phrase("PatientID:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	         ...
	         ////////////////////////////////////
	            ...
	            Paragraph paragraphnew = new Paragraph("Printed time:"+new Date().toString(),new Font(Font.FontFamily.TIMES_ROMAN, 12,
	            	      Font.BOLD));
	           ...
	           // paragraph.add(new Paragraph(" "));
	            paragraph.add(new Paragraph("Adnan",new Font(Font.FontFamily.TIMES_ROMAN, 12,
	            	      Font.NORMAL)));
	            paragraph.setAlignment(Element.ALIGN_LEFT);
...
/*Paragraph paragraphnewnew = new Paragraph("............................................................................................................" +
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////  
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Student Name:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(studentname,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Session:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(session,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Merit Position:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(meritPosition,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	        ...
	        document.add(infotablenew);
	         ...
	         ////////////////////////////////////
	            ...
	            Paragraph paragraphnew = new Paragraph("Bill Prepared by :",new Font(Font.FontFamily.TIMES_ROMAN, 12,
	            	      Font.BOLD));
	            paragraphnew.setAlignment(Element.ALIGN_LEFT);
	            //New line
	         
	           // paragraph.add(new Paragraph(" "));
	            paragraphnew.add(new Paragraph("Adnan",new Font(Font.FontFamily.TIMES_ROMAN, 12,
	            	      Font.NORMAL)));
	            paragraphnew.setAlignment(Element.ALIGN_LEFT);
	            document.add(paragraphnew);
	            */
