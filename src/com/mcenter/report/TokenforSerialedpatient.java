...
public class TokenforSerialedpatient  extends HttpServlet {
 ...
 */
	...
	public String report(String doctorName,String patientName,
			String shift,String patientID,String serialNo,String DateofSerial1) throws Exception{
	        try {
	   ...
	   ////////////////////////////////////////////////////////////       
	         ...
	         //  write.addJavaScript("this.print({bUI: false, bSilent: true, bShrinkToFit:true});",false);
               ...
               PdfPTable table = new PdfPTable(6);
	            ...
	            // create header cell
	            PdfPCell cell = new PdfPCell(new Phrase("Patient Serial",font));
	            ...
	            cellinfo = new PdfPCell(new Phrase(serialNo,new Font(Font.FontFamily.HELVETICA,9,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(DateofSerial1,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase("Shift:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(shift,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
