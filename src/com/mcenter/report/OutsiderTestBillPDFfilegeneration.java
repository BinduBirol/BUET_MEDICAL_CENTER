...
public class OutsiderTestBillPDFfilegeneration  extends HttpServlet {
	        ...
	        /*   // PdfWriter.getInstance(document, baos);
	         ...
	         // headers and footers must be added before the document is opened
	          ...
	          /* PdfPTable table = new PdfPTable(6);
	           ...
	           // Style.headerCellStyle(cell);
	            ...
	            float[] colWidths = {8f,50f,20f,20f};
	            ...
	            cellnew = new PdfPCell(new Phrase("Test Bill",new Font(Font.FontFamily.HELVETICA, 13,
                        Font.BOLD)));
	         ...
	         /*   document.addAuthor("Krishna Srinivasan");
	           ...
	           /* //Create Paragraph
	            ...
	            float[] columnWidths = new float[] {10f, 40f, 20f, 15f,15f,15f};
...
pdfTable.addCell(Double.toString(DAO.getTotal())+" "+"Taka only");*/
	            ...
	            cellword = new PdfPCell(new Phrase("--------------------- Taka--------Paisa only",new Font(Font.FontFamily.HELVETICA, 12,
                        Font.NORMAL)));
	            cellword.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellword.setBorder(Rectangle.NO_BORDER);
	            tableword.addCell(cellword);
