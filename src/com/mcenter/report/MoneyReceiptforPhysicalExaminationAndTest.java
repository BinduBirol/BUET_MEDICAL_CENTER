...
public class MoneyReceiptforPhysicalExaminationAndTest   extends HttpServlet {
 ...
 */
	...
	public String report(String receiptNUMBER,String purpose,String name,String designation,String department) throws Exception{
	        try {
	   ...
	   //////////////////////////////////////////////////////////// 
	          ...
	          PdfWriter writer =PdfWriter.getInstance(document,os);
	            ...
	            cellnew = new PdfPCell(new Phrase("Receipt for Medical  checkup : Client Copy",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
               ...
               PdfPTable table = new PdfPTable(6);
	            ...
	            // create header cell
	            PdfPCell cell = new PdfPCell(new Phrase("Receipt for Medical  checkup  ",font));
	          ...
	          /*  cellinfo = new PdfPCell(new Phrase("Visiting Date:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            cellinfo = new PdfPCell(new Phrase(purpose,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(name,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfo = new PdfPCell(new Phrase(department,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
	         ...
	         /*   cellinfo = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            cellinfo = new PdfPCell(new Phrase(amount,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfo.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfo.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfo.setBorder(Rectangle.NO_BORDER);
...
Paragraph paragraphnewnew = new Paragraph("............................................................................................................" +
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////  
	            ...
	            cellnewnew  = new PdfPCell(new Phrase("Receipt for Medical  checkup: Office Copy",new Font(Font.FontFamily.HELVETICA,10,
                        Font.BOLD)));
	            ...
	            // create header cell
	            PdfPCell cellnewnewnew = new PdfPCell(new Phrase("Receipt for Medical  checkup ",fontnew));
	            // set Column span "1 cell = 6 cells width"
	            ...
	            PdfPTable infotablenew = new PdfPTable(2);
	            infotablenew.setWidthPercentage(50);
	            float[] colWidthsinfonew = {50f,50f};
	            infotablenew.setWidths(colWidthsinfonew);
	            
	            
	            
	            PdfPCell cellinfonew = new PdfPCell();
	          ...
	          /*  cellinfo = new PdfPCell(new Phrase("Visiting Date:",new Font(Font.FontFamily.HELVETICA, 10,
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Purpose:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            infotablenew.addCell(cellinfonew);
	            
	            cellinfonew = new PdfPCell(new Phrase(purpose,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Receipt No:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(receiptNUMBER,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Name:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(name,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Designation:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(designation,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase("Department:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew = new PdfPCell(new Phrase(department,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
...
/*	            cellinfonew = new PdfPCell(new Phrase("Amount:",new Font(Font.FontFamily.HELVETICA, 10,
                        Font.BOLD)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
	            ...
	            cellinfonew= new PdfPCell(new Phrase(amount,new Font(Font.FontFamily.HELVETICA, 9,
                        Font.NORMAL)));
	            cellinfonew.setHorizontalAlignment(Element.ALIGN_LEFT);
	            cellinfonew.setVerticalAlignment(Element.ALIGN_MIDDLE);
	            cellinfonew.setBorder(Rectangle.NO_BORDER);
