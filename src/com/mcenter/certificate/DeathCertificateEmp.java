...
import com.mcenter.certificate.DeathCertificate.TableHeader;
public class DeathCertificateEmp {
	   ...
	   ////////////////////////////////////////////////////////////       
	          ...
	          PdfWriter writer =PdfWriter.getInstance(document,os);
               ...
               PdfPTable table = new PdfPTable(6);
	            ...
	            // create header cell
	            PdfPCell cell = new PdfPCell(new Phrase("Death certificate",font));
	            ...
	            HttpServletRequest request = ServletActionContext.getRequest();
		           String id=request.getParameter("officialId");
		           String victim=request.getParameter("victim");
		           String IDholder=request.getParameter("person");
		           ...
		           age=request.getParameter("age");
		       	   ...
		       	   deathCause=request.getParameter("causeOFdeath");
	            
	            /////////////////////////////////////////
	           System.out.println("Dead Name: "+victim);
	           System.out.println("ID holder:"+IDholder);

	            Paragraph paragraph = new Paragraph("This is to certify that "+victim+", Age:"+age+" years, Sex: "+sex+","
	            		+" expired at "+expireTime+", on "+expireDate+". ",new Font(Font.FontFamily.TIMES_ROMAN, 12,
	            	      Font.NORMAL));
	            ...
	            Paragraph paragraph1 = new Paragraph("The probable cause of death is "+" "+deathCause+".",new Font(Font.FontFamily.TIMES_ROMAN, 12,Font.NORMAL));
	            paragraph1.setAlignment(Element.ALIGN_LEFT);
	            document.add(paragraph1);
	            document.add( Chunk.NEWLINE);
	            document.add( Chunk.NEWLINE);
	            
	            Paragraph paragraphx= new Paragraph("IDHolder Information:", new Font(Font.FontFamily.COURIER, 9, Font.BOLD));
	            Paragraph paragraphy= new Paragraph("ID: "+id+", Name: "+IDholder+", Designation: "+designation+", Department: "+department+", Relation: "+ relation, new Font(Font.FontFamily.COURIER, 9, Font.NORMAL));
	         ...
	         // setting some response headers
	           ...
	           response.setHeader("Content-Disposition", "attachment;filename="+fileName);
				...
				String deathCt="INSERT INTO death_cirtificate" +
						"(holder_id, holder_name, dead_name, dead_cause, dead_date, print_date) " +
						"VALUES (?,?,?,?,?,?)";
				PreparedStatement pstm= conn.prepareStatement(deathCt);
				pstm.setString(1, id);
				pstm.setString(2, IDholder);
				pstm.setString(3, victim);
				pstm.setString(4, deathCause);
