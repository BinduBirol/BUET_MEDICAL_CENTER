...
.additionForm {
   ...
   <h1 align= center><font size="5" color="green">Test assign form</font></h1>	
...
<tr>
<td>
<s:textfield label="Receipt N0" id="receiptNO"/>
...
<div style="width:700px" id="testlist">                    	
 	...
 	<form action="savetestlisttaction" method="post">
	<s:hidden id="receiptNOhidden" name="receiptNO"> </s:hidden>
