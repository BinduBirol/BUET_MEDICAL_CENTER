...
<script type="text/javascript">
	 $(document).ready(function () {
        $('#ComTableContainer').jtable({
            title: 'Table of Company',
            actions: {
                listAction: 'ComController?action=list',
                createAction:'ComController?action=create',
                updateAction: 'ComController?action=update',
                deleteAction: 'ComController?action=delete'
