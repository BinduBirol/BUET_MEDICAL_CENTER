...
/* 	$(function() {
    ...
    function fetchallhistory() {
        ...
        $.get("/MCENTER/fetchalllist1.action", {fdate: fdate, tdate: tdate}, popuDetails);
    }
...
<table class="display dataTable" id="table" width="600px" >
	<tr>
	    ...
	    <td>
	        <input type="button" class="myButton" style="width: 140px;" value="OK" onclick="fetchallhistory()"/><br>
	    </td>
	  </tr>
