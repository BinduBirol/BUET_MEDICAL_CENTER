...
<tr>
<td>
<s:textfield label="Ear" id="globalear" name="globalear" readonly="true"/>
</td>
</tr>
<tr>
<td>
<s:textfield label="Nose" id="globalnose" name="globalnose" readonly="true"/>
</td>
</tr>

<tr>
<td>
<s:textfield label="Teeth" id="globalteeth" name="globalteeth" readonly="true"/>
</td>
</tr>
<tr>
<td>
...
<div id="flip"><font size="4" color="blue">Click for  Test Result </font></div>
<div id="panel">

 <%-- <s:form action="newStudentphysicalexaminationANDtestresultPRINTaction">   --%>
 <s:form>  
