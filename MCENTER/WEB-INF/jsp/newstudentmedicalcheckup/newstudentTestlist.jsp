...
<form action="rePrintNewStudentAssignedTestReportAction"
						name="rePrintNewStudentAssignedTest" id="rePrintNewStudentAssignedTest" method="post">
<input type="hidden" id="dataString" name="dataString" />
 <input id="testlistreportofnewstudentaction_receiptNUMBER" name="receiptNUMBER" value="" type="hidden">
	<fieldset class="row1">
		<legend >
			 Summary Information
		</legend>
...
onclick="return downloadReceipt('<s:property value="receiptNO"/>')" 
									>
									<span>Print</span>
									</button>
										 </td> 									
...
<script type="text/javascript">
	...
	$("#testlistreportofnewstudentaction_receiptNUMBER").val(a);
			//alert($("#testlistreportofnewstudentaction_receiptNUMBER").val());
			//return false;
		}
