...
function printPdf(){
    ...
    //document.getElementById('loginForm').submit();
    window.location="previouspReport.action?prescriptionid="+pid+"&doctorname="+doctorname; 
	...
	<div class="oneThirdDiv">
		...
		<div class="fleft">
			...
			<s:iterator value="oeinfo">
			   <tbody>
			      <tr>
		            <td>* <s:property value="oename"/>:<s:property value="oetype"/> <s:property value="oecomments"/></td>		            	            
			      </tr>		
			   </tbody>
			</s:iterator>		    
			</table>
...
<input type="button" id="printPrescription" value="Print Prescription" onclick="printPdf()"/>
