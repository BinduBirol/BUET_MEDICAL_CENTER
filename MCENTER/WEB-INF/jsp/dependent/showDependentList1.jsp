...
<tr>
<td>
<s:textfield label="ID holder Name" id="person"  name="person" readonly="true"/>
</td>
</tr>
...
<s:textfield label="Official Id" id="officialId" name="officialId" readonly="true"/>
...
<s:form action="addDependent1" method="post" margin="auto">

    <s:submit value="GO Back" theme="simple" cssClass="btn btn-small"  align="center"/>
</s:form>
</div>
<div style="float: left;">
&nbsp;
...
<div style="float: left;">
<s:submit   id="update" value="Update" theme="simple" cssClass="btn btn-primary btn-large" />
</div>
</div>
...
<div id="edit">
	...
	<br/>
		<legend>Edit</legend>
<s:form action="updatedependentaction" theme="xhtml">	
<table align="center" style="border-spacing: 4px;">
<tr>
<td>
<s:textfield label="Dependent ID" id="dependentID" name="dependentID" readonly="true"  />
</td>
</tr>

<%-- <tr>
<td>
<s:textfield label=" New Dependent ID" id="newdependentID" name="newdependentID" placeholder="Fill Must"   />
</td>
</tr> --%>

<tr>
<td>
<s:textfield label="Dependent Name" id="dependentName" name="dependentName" placeholder="Fill Must"  />
</td>
</tr>

<tr>
<td>
<s:textfield label="Date of Birth(dd/mm/yyyy)*" id="dateofbirth"  name="dateofbirth" placeholder="dd/mm/yyyy"  />
...
<td>
<s:select id="gender" list="{'Male','Female'}"  name="gender" label="Gender"/>
...
<td>
<s:select id="relation" list="{'Father','Mother','Son','Daughter','Husbend','Wife'}" name="relation" label="Relation"/>
