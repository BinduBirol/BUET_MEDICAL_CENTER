...
$( "#SerialNo" ).blur(function() {
  ...
  $.ajax({
                        ...
                        url: "searchprescribedPersonbypharmasistaction",
...
<h1 align= center><font size="5" color="green"> Search Prescription  by Pharmasist </font></h1>	
	
	
 <fieldset class="additionForm">
	
		<legend> Search Prescription  by Pharmasist</legend>		

<s:form action="searchprescriptionbyPharmasistaction"> 
