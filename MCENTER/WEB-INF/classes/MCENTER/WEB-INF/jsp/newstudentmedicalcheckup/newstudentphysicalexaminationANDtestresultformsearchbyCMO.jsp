...
$( "#receiptNO" ).keyup(function() {
  ...
  $.ajax({
                        ...
                        url: "searchstudentformedicalcheckupaction",
                        ...
                        success: function(Adnan){
                             ...
                             $("#name").val(Adnan.studentname);
                              $("#session").val(Adnan.acadenicsession);
...
<s:form action="newstudentphysicalexaminationANDtestresultfoundbyCMOaction" theme="xhtml"> 
...
<tr>
<td>
<s:textfield label=" Name" id="name" readonly="true"  />
</td>
</tr>

<tr>
<td>
<s:textfield  label="Academic Session" id="session" readonly="true" />
</td>
</tr>

<tr>
<td>
<s:textfield  label="Merit Position" id="meritPosition" readonly="true"/>
</td>
</tr>
