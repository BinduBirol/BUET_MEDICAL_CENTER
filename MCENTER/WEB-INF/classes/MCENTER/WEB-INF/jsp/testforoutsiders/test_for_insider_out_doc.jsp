...
<fieldset class="additionForm">
	<br/>
		<legend>Insider Test Patient Info</legend>
	
	
	

 <s:form action="save_Test_insider_out_doc" theme="xhtml"> 
...
<tr>
<td>
<s:textfield label="Referenced Doctor" id="doctor" name="doctor" value="%{refDoctor}" />
...
<tr>
<td>
<s:hidden label="PersonID" id="personID" name="personID" value="%{personID}"  />
...
<td>
<s:submit   id="saveTestforOthers"  value="Entry"   theme="simple" align="center"  cssClass="btn btn-primary btn-large" />
...
<tr>
<td>
<s:url action="reportInsiderOutDoc" var="testbill" >
    			<s:param name="visitID" value="visitID"></s:param>
			 </s:url>
...
<td>
<s:submit   onclick="test_for_insider_out_doc.jsp" id="Newpatient"  value="New Patient"   theme="simple" align="center"  cssClass="btn btn-primary btn-large" /> 
</td>		
</tr>			
</table>
