<%@include file="/WEB-INF/jsp/template/head.jsp" %>
    ...
    <fieldset class="additionForm">
        ...
        <s:form action="testtanmayShowaction">
        ...
        <tbody id="tableBody">
            ...
            <s:iterator value="dailydoctorvspatientlist">
                <tr>
                    ...
                    <td><s:property value="visitingdate" />
                    </td>
                    <td><s:property value="patientnumber" />
                    </td>
                    <td><s:property value="serialNo" />
                    </td>
                    <td><s:property value="patient" />
                    </td>
                    <td><s:property value="doctor" />
                    </td>
                    <td>
                        <s:url action="printAction" var="urltag" escapeAmp="false" >
                            <s:param name="pBean.dvisitingdate">
                                <s:property value="visitingdate" />
                            </s:param>

                            <s:param name="pBean.dpatientnumber">
                                <s:property value="patientnumber" />
                            </s:param>
                            <s:param name="pBean.dserialNo">
                                <s:property value="serialNo" />

                            </s:param>
                            <s:param name="pBean.dpatient">
                                <s:property value="patient" />

                            </s:param>
                            <s:param name="pBean.ddoctor">
                                <s:property value="doctor" />

                            </s:param>
                            <s:param name="pBean.dpatientID">
                                <s:property value="patientID" />

                            </s:param>
                            <s:param name="pBean.dshift">
                                <s:property value="shift" />

                            </s:param>
                        </s:url> <a href="<s:property value="#urltag" />" >Print</a>
                    </td>
